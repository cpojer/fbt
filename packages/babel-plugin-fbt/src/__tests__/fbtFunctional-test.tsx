...
function describeTestScenarios(
  testCases: TestCases,
  ...
  describe('Translation transform', () => {
    ...
    testSection(filteredTestCases, transform);
  });
  ...
  describe('Meta-data collection', () => {
    ...
    function testFbtMetaData(title: string, testCase: TestCase) {
      test(
        `for scenario "${title}"`,
    ...
    function testFbtNodeCreation(title: string, testCase: TestCase) {
      test(
        `for scenario "${title}"`,
        withThrowExpectation(testCase.throws, () => {
...
describe('Functional FBT API', () => {
  describe('using string-concatenated arguments:', () => {
    describeTestScenarios(testCases, 'input');
  });

  describe('using array arguments:', () => {
    describeTestScenarios(testCases, 'inputWithArraySyntax');
  });
});
